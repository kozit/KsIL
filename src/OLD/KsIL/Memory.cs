...
namespace KsIL
{
    public class Memory
    {
        ...
        public byte[] GetDataPionter(int Addr)
        {
            ...
            if (Get(Memory.MEMORY_MODE) == 0x00)
            {
            ...
            else if (Get(Memory.MEMORY_MODE) == 0x01)
            {
            ...
            else if (Get(Memory.MEMORY_MODE) == 0x02)
            {
            ...
            else if (Get(Memory.MEMORY_MODE) == 0x03)
            {
        ...
        public void Set(int Addr, byte Value)
        {
            Console.WriteLine("setting {0} @ {1}", Addr, Value);
            Buffer[Addr] = Value;
        }
